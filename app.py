...
Beim Modell ohne Rauschen eignet sich die Anzahl der Trainings-Epochen von 100 bereits, 150 ist noch präziser und liefert z. B. einen sehr geringen Train Loss von 0,0025 und Test Loss von 0,0178. 
Das Best-Fit-Modell habe ich unterschiedlich eingestellt, z. B. Epochenanzahl von 190 oder 200. Bei 190 beträgt eines meiner besten Ergebnisse 0,0367 (Train Loss) und 0,0745 (Test Loss) oder auch 0,053 und 0.0527. Hier war wichtig, dass Train und Test Loss eine geringe Differenz haben, weil dies auf eine gute Generalisierung hinweist. 
Train und Test Loss sind bei den ersten beiden Modellen niedrig, aber der Test Loss ist meistens etwas höher als der Train Loss. Dies liegt daran, dass das Modell auf neue Daten gut generalisieren kann, aber nicht unbedingt so gut wie auf die Trainingsdaten. 
...
Die Komplexität des Modells und die Parametereinstellungen sind entscheidend für die Leistung des neuronalen Netzes. Das FFNN kann sich dann anders verhalten (z. B. kann der Train Loss 0 betragen, wenn die Datenpunkte deutlich reduziert werden). Es hat sich für mich hier bestätigt, dass kleinere Datensätze anfälliger für Overfitting sind. 
